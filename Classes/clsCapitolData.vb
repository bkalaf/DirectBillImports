...
Public Class clsCapitolData
    ...
    Public Sub ClearDataFromCapitolTable()
        Try
            With Connection
            ...
            With Command
                ...
                .CommandTimeout = 0
                .CommandText = "DirectBill_Delete_Capitol"
                .CommandType = CommandType.StoredProcedure
                .ExecuteNonQuery()
            End With
            Debug.WriteLine("Capitol table has been cleared.")
    ...
    Function ImportFileToCapitolTable() As String
        ...
        Try
            ...
            Dim sCon As String = ""
            Dim tableName As String = ConfigurationSettings.AppSettings("CapitolPath")
                ...
                Try
                    ...
                    With sCommand
                        ...
                        For Each row1 In dSet.Tables(0).Rows
                            .CommandText = "DirectBill_Insert_Capitol"
                            .CommandType = CommandType.StoredProcedure
                            ...
                            .Parameters.AddWithValue("@AIMPOLICYNUMBER", row1(2))
                            .Parameters.AddWithValue("@LOB", row1(3))
                            .Parameters.AddWithValue("@NAMEDINSURED", row1(4))
                            .Parameters.AddWithValue("@INSUREDADDRESS", row1(5))
                            .Parameters.AddWithValue("@INSUREDCITY", row1(6))
                            .Parameters.AddWithValue("@INSUREDSTATE", row1(7))
                            .Parameters.AddWithValue("@INSUREDZIP", row1(8))
                            .Parameters.AddWithValue("@TRANSACTIONTYPE", row1(9))
                            .Parameters.AddWithValue("@POLICYEFFDATE", Convert.ToDateTime(row1(10)))
                            .Parameters.AddWithValue("@POLICYEXPDATE", Convert.ToDateTime(row1(11)))
                            .Parameters.AddWithValue("@TRANSACTIONEFFDATE", Convert.ToDateTime(row1(12)))
                            .Parameters.AddWithValue("@TRANSACTIONEXPDATE", Convert.ToDateTime(row1(13)))
                            .Parameters.AddWithValue("@PREMIUM", row1(14))
                            .Parameters.AddWithValue("@TRIA", row1(15))
                            .Parameters.AddWithValue("@GROSSCOMMRATE", row1(16))
                            .Parameters.AddWithValue("@GROSSCOMMAMOUNT", row1(17))
                            .Parameters.AddWithValue("@AGENTCOMMRATE", row1(18))
                            .Parameters.AddWithValue("@DBA", row1(19))
                            .Parameters.AddWithValue("@UNDERWRITER", row1(20))
                            .Parameters.AddWithValue("@COMPANYID", row1(21))
                            .ExecuteNonQuery()
                            .Parameters.Clear()
                        Next
    ...
    Function StageCapitol() As String
        StageCapitol = ""
        ...
        Try
            ...
            With Command
                .Connection = Connection
                .CommandTimeout = 0
                .CommandText = "DirectBillCapitol"
                .CommandType = CommandType.StoredProcedure
                rTrav = .ExecuteReader
            End With
            While rTrav.Read
                StageCapitol = rTrav.Item(0)
            End While
            CloseConnections()
        Catch ex As Exception
            Debug.WriteLine(ex.Message & vbCrLf & ex.StackTrace)
