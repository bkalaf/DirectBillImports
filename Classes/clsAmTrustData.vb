...
Class clsAMTrustData
    ...
    Public Sub ClearDataFromAMTrustTable()
        Try
            With Connection
            ...
            With Command
                ...
                .CommandTimeout = 0
                .CommandText = "DirectBill_Delete_AMTrust"
                .CommandType = CommandType.StoredProcedure
                .ExecuteNonQuery()
            End With
            Debug.WriteLine("AMTrust table has been cleared.")
    ...
    Function ImportFileToAMTrustTable() As String
        ...
        Try
            ...
            Dim sCon As String = ""
            Dim tableName As String = ConfigurationSettings.AppSettings("AMTrustPath")
                ...
                Try
                    ...
                    With sCommand
                        ...
                        For Each row1 In dSet.Tables(0).Rows
                            .CommandText = "DirectBill_Insert_AMTrust"
                            .CommandType = CommandType.StoredProcedure
                            ...
                            .Parameters.AddWithValue("@UNDERWRITER", row1(16))
                            .ExecuteNonQuery()
                            .Parameters.Clear()
                        Next
    ...
    Function StageAMTrust() As String
        StageAMTrust = ""
        ...
        Try
            ...
            With Command
                .Connection = Connection
                .CommandTimeout = 0
                .CommandText = "DirectBillAMTrust"
                .CommandType = CommandType.StoredProcedure
                rTrav = .ExecuteReader
            End With
            While rTrav.Read
                StageAMTrust = rTrav.Item(0)
            End While
            CloseConnections()
        Catch ex As Exception
            Debug.WriteLine(ex.Message & vbCrLf & ex.StackTrace)
